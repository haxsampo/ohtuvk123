...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilimaksu(self):
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        #(self, nimi, viitenumero, tililta, tilille, summa):
        pankki_mock.tilisiirto.assert_called_with("pekka", 42, "12345", "33333-44455", 5)
        # toistaiseksi ei välitetä kutsuun liittyvistä argumenteista

    def test_kaksi_tuotetta_tilimaksu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        viitegeneraattori_mock.uusi.return_value = 42
        varasto_mock = Mock()
    ...
    def test_tilimaksu_kaksi_samaa_tuotetta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        viitegeneraattori_mock.uusi.return_value = 42
        varasto_mock = Mock()
    ...
    def test_tilimaksu_lopussa_oleva_tuote(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        viitegeneraattori_mock.uusi.return_value = 42
        varasto_mock = Mock()
    ...
    def test_poistaminen_korista(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        viitegeneraattori_mock.uusi.return_value = 42
        varasto_mock = Mock()
        ...
        varasto_mock.hae_tuote.assert_called_with(ANY)
        varasto_mock.palauta_varastoon.assert_called_with(ANY)